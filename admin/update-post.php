        ...
        <div class="row">
            ...
            <div class="col-md-offset-3 col-md-6">
                ...
                $sql = "SELECT post.post_id, post.title,post.description,
                    category.category_name,post.post_img, post.category FROM post LEFT JOIN category ON post.category=category_id
                        ...
                        <form action="save-update-post.php" method="POST" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="category">
                                    ...
                                    ?>
                                    <input type="hidden" name="old-category" value="<?=$row['category']?>">
                                </select>
                            </div>
                            <div class="form-group">
